...
void ray_caster_class::get_param(const ros::NodeHandle& nh)    {
    nh.param("/planner_node/p_downsampling_factor", p_downsampling_factor, 2.0);
    nh.param("/planner_node/p_ray_length", p_ray_length, 5.0);   // default 1.0
    nh.param("/planner_node/p_focal_length", p_focal_length, 320.0);
    nh.param("/planner_node/p_resolution_x", p_resolution_x, 640);
    nh.param("/planner_node/p_resolution_y", p_resolution_y, 480);
